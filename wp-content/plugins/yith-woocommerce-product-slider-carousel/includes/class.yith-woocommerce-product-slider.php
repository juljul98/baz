...
if( !class_exists( 'YITH_WooCommerce_Product_Slider' ) ) {
    ...
    class YITH_WooCommerce_Product_Slider
    {
        ...
        public function include_style_script()
        {
            ...
            wp_register_script('ywcps-owl-carousel', YWCPS_ASSETS_URL . 'js/owl.carousel.js', array('jquery'), '1.0.0', true);
        }
        ...
        public function include_admin_style_script( )
        {
            ...
            //ywcps_shortcode
            wp_register_script( 'ywcps_admin_script', YWCPS_ASSETS_URL . 'js/yith_admin_product_slider'.$suffix.'.js', array('jquery'), '1.0.0', true );
